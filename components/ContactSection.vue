          ...
          <div class="flex flex-col space-y-6">
            <div class="flex items-start">
              ...
              <div>
                ...
                <a href="mailto:contact@clangroth.fr" class=" hover:underline">contact@clangroth.fr</a>
              </div>
            </div>
            ...
            <div class="flex items-start">
              ...
              <div>
                ...
                <a href="tel:+33688144084" class="hover:underline">06 88 14 40 84</a>
              </div>
            </div>
            ...
            <div class="flex items-start">
              ...
              <div>
                ...
                <a href="https://www.linkedin.com/in/clangroth/" target="_blank" rel="noopener noreferrer" class="hover:underline">linkedin.com/in/clangroth</a>
              </div>
            </div>
            ...
            <div class="flex items-start">
              ...
              <div>
                <h3 class="text-sm font-medium text-gray-700 mb-1">GitHub</h3>
                <a href="https://www.github.com/dnj855" target="_blank" rel="noopener noreferrer" class="hover:underline">github.com/dnj855</a>
              </div>
            </div>
